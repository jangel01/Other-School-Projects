...
g++ -c -m64 -Wall -fno-pie -no-pie -o reciprocal_sum.o reciprocal_sum.cpp -std=c++17

echo "Comple statistics.cpp"
g++ -c -m64 -Wall -fno-pie -no-pie -o statistics.o statistics.cpp -std=c++17
...
g++ -m64 -fno-pie -no-pie -o go.out isfloat.o reciprocal_sum.o statistics.o harmonic.o -std=c++17
